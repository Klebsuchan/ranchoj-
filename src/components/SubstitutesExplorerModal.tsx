      ...
      >
        ...
        <div className="p-4 bg-amber-50 border-b border-amber-200/80 flex items-center justify-between gap-3 text-xs text-amber-950">
          <div className="flex items-center gap-2">
            ...
            <span>
              Economia potencial total identificada: <strong className="text-emerald-700 font-extrabold text-sm">R$ {totalPotentialSavings.toFixed(2)}</strong> em marcas alternativas.
            </span>
          </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <div className="flex flex-wrap items-center gap-2 text-xs">
                        ...
                        <span className="inline-flex items-center gap-0.5 font-bold text-emerald-700 bg-emerald-100/70 px-2 py-0.5 rounded-md">
