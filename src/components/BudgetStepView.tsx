    ...
    <div className="space-y-5 pb-6">
      ...
      <div className="bg-white border border-slate-200/90 rounded-2xl p-4 shadow-2xs space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2 text-red-600 text-xs font-bold uppercase tracking-wider mb-0.5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Ex: 2500"
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-900 font-bold text-base focus:bg-white focus:outline-none focus:ring-2 focus:ring-red-500 transition"
                />
              </div>
                ...
                {[
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className={`text-[10px] mt-0.5 ${isSelected ? 'text-red-100' : 'text-slate-400'}`}>
                        {item.desc}
                      </span>
                    </button>
                  );
      ...
      <div className="bg-slate-900 text-white p-3.5 rounded-2xl flex items-center justify-between gap-3 shadow-xs">
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-xl bg-red-600 hover:bg-red-500 text-white font-bold text-[11px] shrink-0 transition"
        >
      ...
      <div className="pt-2">
        <button
          type="button"
          onClick={onNextStep}
          className="w-full py-3.5 px-4 rounded-2xl bg-red-600 hover:bg-red-700 text-white font-extrabold text-sm flex items-center justify-center gap-2 shadow-md transition active:scale-98"
        >
